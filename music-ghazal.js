...
const audio1 = new Audio("ghazals/hamari.mp3");
const audio2= new Audio("");
const audio3 = new Audio("ghazals/hungama.mp3");
const audio4 = new Audio("ghazals/chupke.mp3");
const audio5 = new Audio("ghazals/rafta.mp3");
const audio6 = new Audio("qawwali/kuja.mp3");
const audio7 = new Audio("ghazals/agar.mp3");
const audio8= new Audio ("ghazals/humko.mp3");
